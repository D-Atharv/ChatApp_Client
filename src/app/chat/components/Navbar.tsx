        ...
        <nav className="border border-gray-200 bg-blue-gradient mx-2 my-2 rounded-xl">
            <div className="relative max-w-screen flex items-center justify-between p-4 px-10">
                ...
                <div className="flex items-center space-x-3 relative" ref={dropdownRef}>
                    ...
                    {dropdownOpen && (
                        <div className="absolute right-0 top-full mt-2 w-48 bg-gray-800 divide-y divide-gray-100 rounded-lg shadow dark:bg-blue-gradient dark:divide-gray-600 z-50">
